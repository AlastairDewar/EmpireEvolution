...
<div id="wrapper">
  <div id="header"> <img src="<?=base_url()?>images/admin/logo_green.jpg" height="116" width="530" alt="Logo" />
    <ul id="navigation">
	  ...
	  <li class="current_page_item"><?php echo anchor('admin/research', 'Research'); ?></li>
    </ul>
    <p id="user_info">Logged in as {username}, <?php echo anchor('member/logout', 'Logout?'); ?></p>
  </div>
  <div id="content">
    <h1>Research Dashboard</h1>
    <p>Welcome {username} to the admin research dashboard.</p>
    <div class="break"></div>
    <h1>Whats been going on? <?php echo anchor('feed/admin_research', '<img src="'.base_url().'images/rss.png" alt="RSS Feed" width="16px" height="16px"/>');?></h1>
      <table width="610px" border="0" cellspacing="0" cellpadding="0">
		...
		<?php foreach($research_logs as $item):?>
				<tr>
    ...
    <ul>
      <li><?php echo anchor('admin/member_view_all/', 'View all research technologies'); ?></li>
      <li><?php echo anchor('admin/member_add/', 'Add a new research technology'); ?></li>
      <li><?php echo anchor('admin/member_edit/', 'Edit a research technology'); ?></li>
	  <li><?php echo anchor('admin/member_remove/', 'Remove a research technology'); ?></li>
    </ul>
  </div>
      <br class="clear" />
  <div id="footer"> </div>
