...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <ul>
      <li><?php echo anchor('admin/member_view_all/', 'View all members'); ?></li>
      <li><?php echo anchor('admin/member_add/', 'Add a new member'); ?></li>
      <li><?php echo anchor('admin/member_edit/', 'Edit a members profile'); ?></li>
	  <li><?php echo anchor('admin/member_remove/', 'Remove a members profile'); ?></li>
    </ul>
  </div>
      <br class="clear" />
  <div id="footer"> </div>
