...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <h1>News article successfully added!</h1>
		...
		<p>If you have chosen to publish it, it will now be available to all users via the <?php echo anchor('news/', 'news page'); ?>. Otherwise it will be available only for administrators to view via the Administrators panel.</p>
      <br class="clear" />		  
  </div>
    <div id="sidebar">
    <h2>News</h2>
